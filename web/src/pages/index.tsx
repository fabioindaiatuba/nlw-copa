      ...
      <main>
        ...
        <div className='mt-10 flex items-center gap-2'>
          ...
          <strong className='text-gray-100 text-xl'>
            <span className='text-ignite-500'>+{props.userCount}</span> pessoasjá estão usando
          </strong>
        </div>

        <form onSubmit={createPool} className='mt-10 flex gap-2'>
          <input
            className='flex-1 px-6 py-4 rounded text-gray-300 bg-gray-800 border border-gray-600 text-sm'
            type="text"
            required
            value={poolTitle}
